...
num_realization = 1 # the effective total number of realizations is num_realization*num_δs
num_δs = 1  # If one uses a single delta, `amp_delta' has be set to null
